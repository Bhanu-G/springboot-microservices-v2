package com.microservice.currency.conversion.model;
...
public class CurrencyConversion {
	...
	public CurrencyConversion(Long id, String from, String to, BigDecimal conversionMultiple, BigDecimal quantity,
			BigDecimal totalCalAmount, String environment) {
		this.id = id;
		this.from = from;
		this.to = to;
	...
	public String toString() {
		return "CurrencyConversion [id=" + id + ", from=" + from + ", to=" + to + ", quantity=" + quantity
				+ ", conversionMultiple=" + conversionMultiple + ", totalCalAmount=" + totalCalAmount + ", environment="
				+ environment + "]";
	}
